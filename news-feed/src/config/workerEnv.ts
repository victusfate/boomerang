...
export const WORKER_ENV_HELP =
  'Copy news-feed/.env.example to news-feed/.env and set VITE_RSS_WORKER_URL, VITE_META_WORKER_URL, VITE_SYNC_WORKER_URL, and VITE_REC_WORKER_URL (no trailing slashes). Restart the dev server, or rebuild for production.';
