...
function pickStructuredImage(record: Record<string, unknown>, articleUrl: string): string | undefined {
  const raw =
...
// Re-export for use in handler
export { isAllowedOgFetchUrl, extractOgImageFromHtml };
